...
<form action="<?php echo current_url()?>" method="post">
	<div class="row">
		<div class="col-xs-6">
			<p><b>Вы можете выбрать дату и время, когда у Вас не получится поработать. В календаре это время будет отмечено как занята. В таком случае Вы не сможете брать заказ на это время!</b></p>
			<?php echo $event_form?>
		</div>
		<div class="col-xs-6">
